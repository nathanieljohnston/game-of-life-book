...
\begin{figure}[!htb]
	...
	\caption{Construction starts at the child's south corner. The logic circuit (highlighted in \bgbox{aquaback}{aqua}, including the clock gun) will now be constructed by the elbow block circled in \bgbox{redback}{red}.}
...
\begin{figure}[!htb]
	...
	\caption{The child's kernel has been constructed. A glider goes through a brand new Snark that leads it to the \texttt{CN} construction site to trigger construction of the nucleus walls.}
