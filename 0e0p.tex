...
Meanwhile, parent metacells have served their purpose (they have built all of their children and sent state information to them), so they are free to die. The Herschel that is present in \emph{their} south clock guns at $t = 8{\thousep}053{\thousep}063{\thousep}680 = 15 \times 2^{29}$ trigger this self-destruction.% A bit more is needed here. Maybe a figure after south area is destroyed and mention where gliders have fired off to
