...
\begin{itemize}
	...
	\item Cycle 14: The single-channel glider stream is emptied out of the metacell's nucleus. The metacell's state is then sent to all four of its neighbors.\smallskip
...
%%%%%%%%%%%%%%%%%%%%%%
\subsection{Generations $\mathbf{2 \times 2^{29}}$ to $\mathbf{4.00 \times 2^{29}}$: Construction of the Northeast Child}\label{sec:0e0p_timeline_northeast_child}
%%%%%%%%%%%%%%%%%%%%%%
