...
\fi
	...
	\begin{problemstar}\label{exer:2_engine_cordership} \probdiff{3}
		A Cordership that makes use of just $2$ switch engines\footnote{Found by user “praosylen” on the ConwayLife.com forum in December 2017.} is displayed below, along with several incoming gliders that it can reflect in different ways.
