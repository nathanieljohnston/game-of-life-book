...
\begin{problem}\label{exer:tubstretcher_modify}
	...
	\begin{enumerate}[label=\bf\color{ocre}(\alph*)]
		\item Modify the tubstretcher so that it stretches a boat instead of a tub (it would now be called a \emph{boatstretcher}).\index{boatstretcher}
