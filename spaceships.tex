...
\vspace*{-0.4cm}\hrulefill\vspace*{-0.3cm}\footnotesize\begin{multicols}{2}\vspace*{-0.4cm}\raggedcolumns\interlinepenalty=10000
	...
	\begin{problem}\label{exer:hivenudger_modify}
		...
		\begin{enumerate}[label=\bf\color{ocre}(\alph*)]
			...
			\item How many different hivenudgers can be constructed by using xWSSes at its four corners? [Hint: The answer is not $3^4 = 81$. Try either listing all possibilities or looking up a mathematical result called Burnside's lemma, which can be used to compute the answer.] % 45. Burnside's lemma gives (1/2) * (81 + 9) = 45.
		\end{enumerate}
	\end{problem}
