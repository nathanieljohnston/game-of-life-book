...
\fi
	...
	Show how the following period~$38$ oscillator\footnote{Found by David Raucci in January 2022, and essentially the only known period~$38$ oscillator.} can be used to reflect a glider.
