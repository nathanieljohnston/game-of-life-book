...
\begin{figure}[!htb]
	...
	\begin{tabular}{@{}ccc@{}}
		...
		\end{subfigure}
	\end{tabular}
	\caption{Several oscillators that work by hassling pre-honey farms (highlighted in \bgbox{orangeback}{orange}). These oscillators were found by (a,c)~Dongook Lee in 2016 (with improvements to decrease their size by Matthias Merzenich), and (b)~Nico Brown in January 2015.}
