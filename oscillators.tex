...
\fi
	...
	Show how the following period~$38$ oscillator\footnote{Found by David Raucci in January 2022, based on an earlier infinite p$38$ pattern that Jason Summers found in August 2000.} can be used to reflect a glider.
