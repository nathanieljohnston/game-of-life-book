...
\SetWatermarkText{Preprint from conwaylife.com/book (\today). \qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad ${}$}
...
\setcounter{collectmore}{-5}% fixes some footnote placements in multi-column environments (in particular in exercise sections)