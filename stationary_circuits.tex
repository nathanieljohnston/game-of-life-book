...
\vspace*{-0.4cm}\hrulefill\vspace*{-0.3cm}\footnotesize\begin{multicols}{2}\vspace*{-0.4cm}\raggedcolumns\interlinepenalty=10000
	...
	\begin{problem}\label{exer:faster_trombone_slide}
		...
		\begin{enumerate}[label=\bf\color{ocre}(\alph*)]
			...
			% SOLUTION: 2 cells closer, 128 generations.
			...
			% SOLUTION: 1 cell closers, 128 generations.
			...
			% SOLUTION: https://conwaylife.com/forums/viewtopic.php?f=2&t=2784&start=0#p41664
		\end{enumerate}
	\end{problem}
	...
	\begin{problemstar}\label{fig:g_to_2engine_why_10_gliders} \probdiff{2}
