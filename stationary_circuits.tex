...
\begin{figure}[!htb]
	...
	\begin{subfigure}{.485\textwidth}
		\centering
		\patternimglink{0.102}{trombone_slide_276}
		\caption{A path that takes $276$~generations.}\label{fig:trombone_slide_276}
	\end{subfigure} \hfill % 
	\begin{subfigure}{.485\textwidth}
		\centering
		\patternimglink{0.102}{trombone_slide_284}
...
\begin{figure}[!htb]
	\centering
	\patternimglink{0.136}{g_to_2engine_V}
...
\begin{figure}[!htb]
	\centering
	\patternimglink{0.105}{glider_to_2engine_cordership}
