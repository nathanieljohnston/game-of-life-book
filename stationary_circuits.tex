...
% TODO: Move this to history section? We do want Callahan G-to-H, since we discuss it with Gemini
...
\begin{problem}\label{exer:syringe_compact}
	...
	\noindent [Hint: Make use of the modification of eater~5\index{eater!5} that is displayed below on the right.]
\end{problem}
