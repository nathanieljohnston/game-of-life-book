...
\begin{figure}[!htb]
	...
	\begin{subfigure}{\textwidth}
		\centering
		\embedlink{cc_semi_snark}{\vcenteredhbox{\patternimg{0.0948}{cc_semi_snark_0}} \vcenteredhbox{\genarrow{75}} \vcenteredhbox{\patternimg{0.0948}{cc_semi_snark_75}} \vcenteredhbox{\genarrow{27}} \vcenteredhbox{\patternimg{0.0948}{cc_semi_snark_102}}}
...
\fi
	...
	\begin{problem}\label{exer:other_toolkit_stable_conduits}
		Another toolkit for duplicating and synchronizing gliders in stable circuitry, which can be used instead of Table~\ref{tab:conduit_phase_changers}, is provided at \httpsurl{conwaylife.com/forums/viewtopic.php?p=41563\#p41563}. \smallskip
