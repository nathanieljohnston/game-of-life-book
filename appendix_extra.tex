...
In Section~\ref{sec:scorbie_splitter}, we described how to build a single-channel glider recipe that constructs a Scorbie splitter along its path. This recipe consists of 4,006 gliders (specified by 4,005 glider spacings), and is presented here:\footnote{This recipe can be downloaded in RLE format from \httpsurl{conwaylife.com/book}. Alternatively, if you are reading this book electronically in a PDF viewer then you can \embedlink{scorbie_splitter_maker}{click here}.}\\[-0.1cm]
