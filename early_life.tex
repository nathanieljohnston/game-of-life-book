	...
	\begin{problemstar}\label{exer:natural_switch_engine} \probdiff{1}
		...
		\begin{multicols}{2}
			\begin{enumerate}
				...
				\item[\bf\color{ocre}(c)] \raisebox{-\height+\ht\strutbox}{\patternimglink{0.1}{exercise_random_d}}
				
				\item[\bf\color{ocre}(b)] \raisebox{-\height+\ht\strutbox}{\patternimglink{0.1}{exercise_random_a}}
				
				\item[\bf\color{ocre}(d)] \raisebox{-\height+\ht\strutbox}{\patternimglink{0.1}{exercise_random_b}}
			\end{enumerate}
		\end{multicols}
	\end{problemstar}
