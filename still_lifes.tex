...
\fi
	...
	\begin{problem}\label{exer:densest_still_lifes} \probdiff{3}
		Find maximum-density still lifes in $n \times n$ bounding boxes for $n = 4$ and $4, 6,$ and $9$ that are different from those displayed in Table~\ref{tab:still_life_n10}.
	\end{problem}
