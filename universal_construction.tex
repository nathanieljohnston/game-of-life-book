...
In the Gemini itself, the construction elbows are pushed out by $m = 3{\thousep}072$ and $n = 2{\thousep}048$ cells, respectively, for a displacement of $(m-n,m+n) = (1024,5120)$ cells per period, and a slope of $5120/1024 = 5$. We can change this into, for example, a knightship\index{knightship} (i.e., a spaceship with slope $2$) by increasing $m$ and/or $n$ so that $m+n = 2(m-n)$ (i.e., $m = 3n$). The easiest way to do this is to insert another $3{\thousep}072$ \texttt{INC} operations on the northwest construction elbow's path of the Gemini. This will give $m = 3{\thousep}072 + 3{\thousep}072 = 6{\thousep}144$ and $n = 2{\thousep}048$.

% Show knightship, use same coloring/highlighting as original Gemini, but just show the northwest corner

% Talk about how m and n need to be sufficiently large
% Talk about how m and n are not equal to number of INC operations, since near 0 things get fuzzy

% Knightship, slope 3 ship, and lead into asymptotic speed limit
% When talking about lowering past 579 gens, mention lots of crossings to be careful of

% Describe how fast we can make it go, what the limiting factor is. Say not worth showing variations in bookks since they look essentially identical. (Maybe show an ends of the knightship?)
% Gemini adjustments: https://conwaylife.com/forums/viewtopic.php?f=2&t=399&p=2327#p2348
...
% Relevant thread: https://www.conwaylife.com/forums/viewtopic.php?f=2&t=406
