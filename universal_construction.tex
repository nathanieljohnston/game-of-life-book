...
% Mid-section of above paragraph needs work. Explain that speed limit is determined mostly by how quickly we can push the elbow forward
...
We now push these ideas to their absolute limit, and demonstrate how to construct Demonoids with speeds arbitrarily close to $c/4$ (rather than just $c/14$).\footnote{Recall from Theorem~\ref{thm:speed_limits} that no diagonal spaceship can go faster than this.}
...
% Exercise with another way to destroy snark: just fire lots of gliders from the forward direction
...
\vspace*{-0.4cm}\hrulefill\vspace*{-0.3cm}\footnotesize\begin{multicols}{2}\vspace*{-0.4cm}\raggedcolumns\interlinepenalty=10000
	...
	\begin{problemstar}\label{exer:44hd_elbow_push}
		...
		\begin{enumerate}[label=\bf\color{ocre}(\alph*)]
			...
			\item Adding more and more of these 44hd elbow pushes makes the Demonoid faster and faster (but also larger and larger). Explain why it is possible to reach speeds that are arbitrarily close (but not equal) to $22c/2239$, but not $22c/2195$.
		\end{enumerate}
	\end{problemstar}
