...
\end{figure}
	...
	\item In December 2021, Pavel Grankovskiy completed a blueprint posted by ConwayLife.com forums user ``googleplex'' to produce the ``QuickSilver'' Demonoid, using 1990s-era circuitry but definitely 21st-century design techniques. Silver reflectors' recovery time of $497$ ticks is ordinarily far too slow to support single-channel recipes, but universal construction still turned out to be achievable using overclocked Silver reflectors to reflect and duplicate a carefully chosen subset of known single-channel recipes.\smallskip
\end{itemize}
