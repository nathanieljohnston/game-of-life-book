...
\begin{itemize}
	...
	\item In November 2018, Dave Greene constructed \emph{volatility~1 oscillators}\footnote{See \httpsurl{conwaylife.com/wiki/Volatility}}. of arbitrarily large sizes:\index{volatility} oscillator in which all cells oscillate at the full period. These oscillators work by using single-channel glider recipes to destroy and then reconstruct their own circuitry.\smallskip 
\end{itemize}
...
% Putting figure down here to foce exercises header onto same page as it
\begin{figure}[!htb]
	\centering
