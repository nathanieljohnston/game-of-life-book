...
%		\fill[fill=black] (64,64) circle (0.3);
		...
		\draw[darkgreenback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (-0.5,33) -- (4,33) -- (4,59) -- (58,59) -- (58,7) -- (40,7) -- (40,8) -- (57,8) -- (57,19.5) -- (44,19.5) -- (44,20);
		\fill[fill=darkgreenback] (62,29) circle (0.3);
		\fill[fill=darkgreenback] (30,3) circle (0.3);
		\fill[fill=darkgreenback] (4,33) circle (0.3);
		\fill[fill=darkgreenback] (44,20) circle (0.3);
