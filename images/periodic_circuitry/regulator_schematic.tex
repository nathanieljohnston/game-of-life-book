...
\begin{document}
	...
	\begin{tikzpicture}%
		...
		\draw[darkmagentaback] (1,-2.13+0.5) node {\scriptsize LWSS gun};
		...
		\draw[darkyellowback] (4.55,0.53) node {\scriptsize glider gun};
		...
		\draw[darkaquaback] (3.6,4.8) node {\scriptsize MWSS gun};
		...
		\draw[darkaquaback] (3.7,-4.83+0.5) node {\scriptsize LWSS gun};
		...
		\draw[darkmagentaback] (5.75,-4.22) node {\scriptsize glider gun};
		...
		\draw[darkorangeback] (6.75,1.1) node[rotate=45] {\scriptsize output glider};
		\glider{(5.1,-1)}{90}{0.08};
		
		% INPUT GLIDER
		\draw[thick,color=darkgreenback,-stealth] (0.2,2.05) -- (3.5,-1.25);
		\draw[darkgreenback] (1.75,0.7) node[rotate=-45] {\scriptsize input glider};
