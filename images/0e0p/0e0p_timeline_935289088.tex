...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_935289088.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_935289088_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_935289088_zoom1.png}};
		...
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 935}\ \texttt{289}\ \texttt{088}\\ \texttt{{} \ \ttapprox \ 1.74 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}