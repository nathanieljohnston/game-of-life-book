...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_438935522.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_438935522_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom1) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_438935522_zoom1.png}};
		...
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (16,7.15) -- (15.5,6.65);
		
		% CIRCLES
		\draw[white,line width=1.5pt,opacity=0.6](13.49+\gp+\gp,6.42) circle (0.13);
		\draw[redback2,line width=0.6pt](13.49+\gp+\gp,6.42) circle (0.13);
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 438}\ \texttt{935}\ \texttt{522}\\ \texttt{{} \ \ttapprox \ 0.82 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}