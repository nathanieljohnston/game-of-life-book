...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_8124366848.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_8124366848_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom1) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_8124366848_zoom1.png}};
			
			\draw[gridgray,line width=0.6pt] (\bglx,\bgty) rectangle (\bgrx,\bgby);
		% END ZOOM RIGHT
		
		\node[inner sep=0pt,anchor=north west] (genarr) at (9.65,8) {\color{black}{$\xrightarrow{\text{\clock{4}{5} $2 \, 066 \, 824$}}$}};
		
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (5.7,6.65) -- (5.2,7.15);
		
		\draw[color=gray,-stealth] (12.8,6.35) -- (12.3,6.85);
		\draw[color=gray,-stealth] (15.2,6.85) -- (14.7,6.35);
		\draw[color=gray,-stealth] (12.3,8.65) -- (12.8,9.15);
		\draw[color=gray,-stealth] (14.7,9.15) -- (15.2,8.65);
		
		\draw[gray] (1.6,6.2) node {\small\texttt{S}};
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 8}\ \texttt{124}\ \texttt{366}\ \texttt{848}\\ \texttt{{} \ \ttapprox \ 15.13 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}