...
\begin{document}
	\begin{tikzpicture}%
		...
		% ZOOM RIGHT
			\renewcommand\smlx{6.7+\gp}
			\renewcommand\smrx{\smlx+0.3}
			\renewcommand\smby{6.85}
		...
		\draw[gray] (1.9,6.84) node {\small\texttt{CN}};
		
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (15.4,7) -- (14.9,7.5);
		\draw[color=gray,-stealth] (12.6,7.75) -- (12.1,7.25);
