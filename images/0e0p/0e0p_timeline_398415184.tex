...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_398415184.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_398415184_zoom0.png}};
		...
		% ZOOM RIGHT
			\renewcommand\smlx{6.46+\gp}
			\renewcommand\smrx{\smlx+0.48}
			\renewcommand\smby{6.69}
			\renewcommand\smty{\smby+0.48}
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_398415184_zoom1.png}};
		...
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (15,8) -- (14.5,7.5);
		\draw[color=gray,-stealth] (12.15,6.65) -- (11.65,6.15);
		\draw[color=gray,-stealth] (12.15,9.3) -- (11.65,9.8);
		
		% CIRCLES
		\draw[white,line width=1.5pt,opacity=0.6](15.42,8.47) circle (0.15);
		\draw[redback2,line width=0.6pt](15.42,8.47) circle (0.15);
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 398}\ \texttt{415}\ \texttt{184}\\ \texttt{{} \ \ttapprox \ 0.74 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}