...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_334193646.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_334193646_zoom0.png}};
		...
		% ZOOM RIGHT
			\renewcommand\smlx{7.04+\gp}
			\renewcommand\smrx{\smlx+0.4}
			\renewcommand\smby{6.51}
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_334193646_zoom1.png}};
		...
		% CIRCLES
		\draw[white,line width=1.5pt,opacity=0.6](10.03+\gp+\gp,6.03) circle (0.15);
		\draw[redback2,line width=0.6pt](10.03+\gp+\gp,6.03) circle (0.15);
		
		\draw[gray] (2.1,5.60) node {\small\texttt{S}};
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 334}\ \texttt{193}\ \texttt{646}\\ \texttt{{} \ \ttapprox \ 0.62 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}