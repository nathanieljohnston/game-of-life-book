...
\begin{document}
	\begin{tikzpicture}%
		...
		\draw[color=gray,dashed] (8.5,-1.5) -- (10.5,-3.5);
		\draw[color=gray] (10.2,-3.2) node[anchor=south,rotate=-45]{\small\texttt{child}};
		\draw[color=gray] (10.2,-3.2) node[anchor=north,rotate=-45]{\small\texttt{parent}};
