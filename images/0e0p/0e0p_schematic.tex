...
%		\fill[fill=black] (64,64) circle (0.3);
                ...
                \fill[yellowback]  (14.5, 14.5) rectangle (49.5, 49.5);
		...
		\fill[fill=redback2] (9,55) circle (0.3);
                ...
                % Construction arms
		\draw[violet,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (55,9) -- (66, 9);
		\draw[violet,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (55,55) -- (55, 66);
		\draw[violet,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (9, 55) -- (-2, 55);
		\draw[violet,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (9, 9) -- (9, -2);
		...
		\draw[darkgreenback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (-0.5,33) -- (4,33) -- (4,59) -- (58,59) -- (58,7) -- (40,7) -- (40,8) -- (53,8) -- (53,19.5) -- (44,19.5) -- (44,20);
