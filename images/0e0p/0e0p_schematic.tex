...
%		\fill[fill=black] (64,64) circle (0.3);
		...
		\draw[darkmagentaback,thick,-{Latex[length=2mm,width=1.5mm]}] (9,29) -- (9,55) -- (30,55) -- (30,69.5) node[anchor=south,rotate=-45,shift={(-1.1,0)}]{\texttt{outgoing recipe}};
		...
		\draw[darkmagentaback,dashed,thick,-{Latex[length=2mm,width=1.5mm]}] (55,55) -- (55, 67.75) node[anchor=south east,rotate=-45,shift={(0.5,0)}]{\texttt{construction}};
		...
		\draw[darkorangeback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (38,64.5) node[anchor=south west,shift={(-0.2,0.3)},rotate=315]{\texttt{incoming state}} -- (38,52) -- (13,52) -- (13,13) -- (41,13);
		...
		\draw[darkaquaback,thick,-{Latex[length=2mm,width=1.5mm]}] (38,10.5) -- (10,10.5) -- (10,54) -- (26,54) -- (26,64.5) node[anchor=south east,shift={(0.25,-0.25)},rotate=315]{\texttt{outgoing state}};
		...
		% Green wires
		\draw[darkgreenback,thick,{angle 60 reversed[length=2mm,width=1.5mm]}-] (36,69.5) node[anchor=south,rotate=-45,shift={(1.1,0)}]{\texttt{incoming recipe}} -- (36,63) -- (62,63) -- (62,29);
		...
		\draw[darkaquaback] (45.5,12) node[rotate=315] {\texttt{logic}};
