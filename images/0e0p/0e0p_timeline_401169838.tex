...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_401169838.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_401169838_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_401169838_zoom1.png}};
		...
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 401}\ \texttt{169}\ \texttt{838}\\ \texttt{{} \ \ttapprox \ 0.75 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}