...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_400027916.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_400027916_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_400027916_zoom1.png}};
		...
		% CIRCLES
		\draw[white,line width=1.5pt,opacity=0.6](15.22,8.46) circle (0.15);
		\draw[redback2,line width=0.6pt](15.22,8.46) circle (0.15);
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 400}\ \texttt{027}\ \texttt{916}\\ \texttt{{} \ \ttapprox \ 0.75 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}