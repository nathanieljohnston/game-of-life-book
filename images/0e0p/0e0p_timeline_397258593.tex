...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_397258593.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_397258593_zoom0.png}};
		...
		% ZOOM RIGHT
			\renewcommand\smlx{6.885+\gp}
			\renewcommand\smrx{\smlx+0.3}
			\renewcommand\smby{5.7}
			\renewcommand\smty{\smby+0.3}
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_397258593_zoom1.png}};
		...
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (15.4,8.55) -- (14.9,8.05);
		\draw[color=gray,-stealth] (12.8,7.7) -- (12.3,8.2);
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 397}\ \texttt{258}\ \texttt{593}\\ \texttt{{} \ \ttapprox \ 0.74 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}