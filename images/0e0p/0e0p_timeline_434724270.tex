...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_434724270.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_434724270_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\node[inner sep=0pt,anchor=north west] (zoom1) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_434724270_zoom1.png}};
		...
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (15.05,9.45) -- (14.55,8.95);
		
		% CIRCLES
		\draw[white,line width=1.5pt,opacity=0.6](11.64+\gp+\gp,8.27) circle (0.13);
		\draw[redback2,line width=0.6pt](11.64+\gp+\gp,8.27) circle (0.13);
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 434}\ \texttt{724}\ \texttt{270}\\ \texttt{{} \ \ttapprox \ 0.81 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}