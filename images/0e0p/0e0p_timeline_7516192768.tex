...
\begin{document}
	\begin{tikzpicture}%
		...
		\node[inner sep=0pt,anchor=north west] (ca) at (0,9.05) {\includegraphics[width=3.5cm]{0e0p_timeline_7516192768.png}};
		...
		% ZOOM MIDDLE
			...
			\node[inner sep=0pt,anchor=north west] (zoom0) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_7516192768_zoom0.png}};
		...
		% ZOOM RIGHT
			...
			\renewcommand\smrx{\smlx+1.35}
			\renewcommand\smby{6.6}
			\renewcommand\smty{\smby+1.35}
			...
			\node[inner sep=0pt,anchor=north west] (zoom1) at (\bglx,\bgty) {\includegraphics[width=4.5cm]{0e0p_timeline_7516192768_zoom1.png}};
		...
		% GLIDER PATH ARROWS
		\draw[color=gray,-stealth] (13.9,6) -- (13.4,6.5);
		\draw[color=gray,-stealth] (12.8,9.2) -- (12.3,9.7);
		\draw[gray] (12.75,9.9) node[anchor=north west,align=left] {\footnotesize\texttt{0-8 gliders escape}};
		
		\draw[gray] (0,10) node[anchor=north west,align=left] {\texttt{t = 7}\ \texttt{516}\ \texttt{192}\ \texttt{768}\\ \texttt{{} \ = 14 × 2$^{\texttt{29}}$}};
	\end{tikzpicture}
\end{document}