...
\begin{document}
	\begin{tikzpicture}%
		...
		% 8th RAKE
		\newcommand\rakeeightx{2.65}
		\newcommand\rakeeighty{2.9}
		...
		% 9th RAKE
		\newcommand\rakeninex{3.25}
		\newcommand\rakeniney{2.98}
		\draw[gray] (\rakeninex,\rakeniney+0.03) node[rotate=24] {\tiny \texttt{R2L25}};
		\draw[color=gray,-stealth] (\rakeninex-0.23,\rakeniney-0.18) -- (\rakeninex+0.38,\rakeniney+0.11);
		
		% 10th RAKE
		\newcommand\raketenx{3.85}
		\newcommand\raketeny{3.05}
		\draw[gray] (\raketenx,\raketeny+0.03) node[rotate=24] {\tiny \texttt{R6L21}};
