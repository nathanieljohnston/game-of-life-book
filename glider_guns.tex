...
\begin{figure}[!htb]
	...
	\begin{minipage}[t]{.405\textwidth}
		...
		\caption{A true-period~$32$ glider gun that works by using a some p4 and p8 oscillators (highlighted in \bgbox{yellowback2}{yellow} and \bgbox{aquaback}{aqua}, respectively) to hassle a pre-honey farm and a T-tetromino. Built by Martin Grant in October 2021.}\label{fig:p32_glider_gun}
	\end{minipage}
\end{figure}
