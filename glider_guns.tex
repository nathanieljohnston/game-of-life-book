...
\begin{table}[!htbp]\vspace*{0.02in}
	...
	\end{center}
\end{table}
% TODO: Exercise for p49 and p51. (a) gives reaction from p51 ask to complete, (b) give p7 and ask to make p49
