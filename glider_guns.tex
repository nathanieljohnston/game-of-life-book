...
% Exercise: what happens to quad filter if you remove some of the blocks in the trail?
...
% Exercise: growth rate where we add a quad filter and an exp filter? Mention that order matters and changes the growth rate
