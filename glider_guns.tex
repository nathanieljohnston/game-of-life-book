...
\begin{table}[!htbp]\vspace*{0.02in}
	\begin{center}		
		\begin{tabular}{ccll}
			...
			57 & 2016 & Matthias Merzenich & \specialcelll[t]{{\small$\bullet$} smallest known was constructed in April 2021 \\ \hphantom{\small$\bullet$} by Matthias Merzenich and others, \\ \hphantom{\small$\bullet$} based on an engine by David Raucci \\ {\small$\bullet$} first known (not displayed) was large (about $330 \times 350$)} \\
