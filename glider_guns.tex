...
% Next: exponential filters in Notes/History section


% Exercise: make gun with growth rate like O(t^{1/4}). Easy with quad filter. Another: attach to caber tosser. What is growth rate?
