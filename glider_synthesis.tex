...
\begin{table}[!htbp]
	\begin{center}		
		\begin{tabular}{Sc Sl}
			...
			\rowcolor{gray!20} \specialcell{glider-producing \\ switch engine \\ (plus junk)\index{switch engine!glider-producing}} & \specialcell{\gridbox{0.5pt}{\patternimglink{0.2}{3_glider_switch_engine_glider}}} \\\bottomrule
		\end{tabular}
...
\begin{table}[!htbp]
	\begin{center}		
		\begin{tabular}{Sc Sl}
			...
			\rowcolor{gray!20} \specialcell{\embedlink{honey_farm_incremental}{\patternimg{0.08763934426}{hf_cropped}} \\ honey~farm\index{honey farm}} & \specialcell{\patternlink{honey_farm_incremental}{\patternimg{0.1}{honey_farm_incremental}}} \\
