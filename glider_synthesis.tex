...
% TODO: When you get to block move, explicitly call it a (2,1) block pull. \index{(2,1) block pull}

\noindent In previous chapters, we saw several different patterns that were capable of generating an endless supply of gliders. Glider guns like the Gosper glider gun\index{glider gun} and the twin bees gun create streams of gliders coming from a fixed location, and rakes\index{rake} like the space rake create waves of gliders that come from a moving source. We have also seen a few patterns (mostly based on the switch engine\index{switch engine}) capable of creating other objects like blocks or other small still lifes. In this chapter, we develop a systematic method of constructing patterns that turn these simple objects like gliders and blocks into more and more complicated patterns. In particular, we will look at how we can collide gliders together in order to create other objects. For example, it is possible to collide three gliders in such a way as to produce a lightweight spaceship (see Figure~\ref{fig:lwss_3_gliders}).
\begin{figure}[!ht]
...
% TODO: Replace with "highlighted" figure rather than evolution/blue figure
\begin{figure}[!ht]
...
\begin{table}[!htp]\vspace*{0.05in}
	\begin{center}
		\begin{tabular}{Sc Sl Sc Sc Sl}
			\toprule
			result & 2-glider collisions & \qquad \qquad & result & collision \\ \midrule
			\specialcell{\embedlink{2_glider_syntheses}{\patternimg{0.1}{block_cropped}} \\ block\index{block}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_block}}} & \qquad \qquad \qquad & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{boat_cropped}} \\ boat\index{boat}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_boat}}} \\
			
			\rowcolor{gray!20} \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{pond_cropped}} \\ pond\index{pond}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_pond}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{beehive_cropped}} \\ beehive\index{beehive}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_beehive}}} \\
			
			\specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{blinker_cropped}} \\ blinker\index{blinker}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_blinker}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{loaf_cropped}} \\ loaf\index{loaf}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_loaf}}} \\
			
			\rowcolor{gray!20} \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{glider_cropped}} \\ glider\index{glider}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_glider}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{eater_1_cropped}} \\ eater 1\index{eater 1}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_eater_1}}} \\
			
			\specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{hf_cropped}} \\ honey farm\index{honey farm}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_hf}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{biblock_cropped}} \\ bi-block\index{bi-block}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_biblock}}} \\
			
			\rowcolor{gray!20} \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{tl_cropped}} \\ traffic light\index{traffic light}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_tl}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{interchange_cropped}} \\ interchange\index{interchange}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_interchange}}} \\
			...
			\rowcolor{gray!20} \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{b_cropped}} \\ B-hept.\index{B-heptomino}\index{heptomino!B}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_b}}} & & \specialcell{lumps \\ of muck}\index{lumps of muck} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_lom}}} \\
			
			\specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{pi_cropped}} \\ pi-hept.\index{pi-heptomino}\index{heptomino!pi}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_pi}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{teardrop_cropped}} \\ teardrop\index{teardrop}} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_teardrop}}} \\
			
			\rowcolor{gray!20} \specialcell{misc.} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_misc}}} & & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{octomino_cropped}} \\ octomino} & \specialcell{\patternlink{2_glider_syntheses}{\patternimg{0.1}{2_glider_octomino}}} \\
		...
		\end{tabular}
		\caption{A summary of the results of all $71$ possible $2$-glider collisions. The four ``misc'' collisions yield somewhat messy combinations of common objects like blocks and blinkers. The rightmost of the ``misc'' collisions is sometimes called the \emph{two-glider mess}\index{two-glider mess}, as it takes 530 generations to stabilize---more than any of the other collisions.}\label{tab:2_glider_synth}
	\end{center}
\end{table}
...
\begin{table}[!htp]\vspace*{0.05in}
	\begin{center}		
		\begin{tabular}{Sc Sl}
			...
			\specialcell{\embedlink{3_glider_lwss}{\patternimg{0.1}{lwss_cropped}} \\ lightweight spaceship\index{lightweight spaceship}} & \specialcell{\patternlink{3_glider_lwss}{\patternimg{0.1}{3_glider_lwss}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{3_glider_mwss}{\patternimg{0.1}{mwss_cropped}} \\ middleweight spaceship\index{middleweight spaceship}} & \specialcell{\patternlink{3_glider_mwss}{\patternimg{0.1}{3_glider_mwss}}} \\
			
			\specialcell{\embedlink{3_glider_hwss}{\patternimg{0.1}{hwss_cropped}} \\ heavyweight spaceship\index{heavyweight spaceship}} & \specialcell{\patternlink{3_glider_hwss}{\patternimg{0.1}{3_glider_hwss}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{tee}{\patternimg{0.1}{glider_cropped}} \\ glider\index{glider}} & \specialcell{\patternlink{tee}{\patternimg{0.1}{3_glider_tee}}} \\
			
			\specialcell{\embedlink{3_glider_pulsar}{\patternimg{0.1}{pulsar_cropped}} \\ pulsar\index{pulsar}} & \specialcell{\patternlink{3_glider_pulsar}{\patternimg{0.1}{3_glider_pulsar}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{3_glider_pentadecathlon}{\patternimg{0.1}{pentadecathlon_cropped}} \\ pentadecathlon\index{pentadecathlon}} & \specialcell{\patternlink{3_glider_pentadecathlon}{\patternimg{0.1}{3_glider_pentadecathlon}}} \\
			
			\specialcell{\embedlink{3_glider_r_pentomino}{\patternimg{0.1}{r_pentomino_cropped}} \\ R-pentomino\index{R-pentomino}} & \specialcell{\patternlink{3_glider_r_pentomino}{\patternimg{0.1}{3_glider_r_pentomino}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{3_glider_queen_bee}{\patternimg{0.1}{queen_bee_cropped}} \\ queen bee\index{queen bee}} & \specialcell{\patternlink{3_glider_queen_bee}{\patternimg{0.1}{3_glider_queen_bee}}} \\
			
			\specialcell{glider-producing switch \\ engine (plus junk)\index{switch engine!glider-producing}} & \specialcell{\gridbox{0.5pt}{\patternimglink{0.2}{3_glider_switch_engine_glider}}} \\\bottomrule
		\end{tabular}
...
Although the $3$-glider synthesis of a single glider in Table~\ref{tab:3_glider_synth} might seem somewhat silly at first glance, it has the interesting property that the synthesized glider travels perpendicular to each of the input gliders\footnote{Even more specifically, two of the gliders collide in such a way as to destroy each other, but they create a banana spark\index{banana spark} in the process that reflects the third glider as in Figure~\ref{fig:spark_glider_reflect}.}---a property that is not shared by any of its $2$-glider syntheses. For this reason, it is actually quite useful when trying to manipulate glider positions or reduce the number of directions used in glider syntheses of more complicated objects (see Exercise~\ref{exer:glider_synth_tee}).
...
\begin{figure}[!ht]
	...
	\caption{A ten-glider synthesis of a Gosper glider gun, which is composed of two syntheses of blocks (highlighted with an \bgbox{aquaback}{aqua background}) and two syntheses of queen bees. The queen bee synthesis with the \bgbox{magentaback}{magenta background} is the same as the one with the \bgbox{yellowback2}{yellow background}, but delayed by 20 generations in order to make the queen bees collide in their proper phases.}\label{fig:gosper_glider_synth}
\end{figure}

We have a fairly wide variety of objects that we can now synthesize with gliders, but there are still some rather fundamental objects that are missing from our lists of $2$- and $3$-glider syntheses. For example, if we wanted to synthesize a twin bees gun\index{twin bees gun}, we would first have to know how to synthesize twin bees, which (as far as we know) requires at least $4$~gliders. Similarly, even though we can use $3$~gliders to synthesize a glider-producing switch engine (plus lots of debris), we haven't yet seen how to synthesize a switch engine by itself. Again, as far as we know this requires at least $4$~gliders.
...
% TODO: Switch engine how has 3-glider synth:
% #N switchengine_synth
% #O Luka Okanishi, 12 March 2017
% #C 3-glider synthesis of an unstabilized switch engine
% #C conwaylife.com/wiki/index.php?title=Switch_engine
% #C http://conwaylife.com/patterns/switchengine_synth.rle
...
\begin{table}[!htp]\vspace*{0.05in}
	\begin{center}
		\begin{tabular}{Sc Sl Sc Sc Sl}
			...
			\specialcell{\embedlink{4_glider_clock}{\patternimg{0.1}{clock_cropped}} \\ clock\index{clock}} & \specialcell{\patternlink{4_glider_clock}{\patternimg{0.1}{4_glider_clock}}} & \qquad \qquad \qquad & \specialcell{\embedlink{twin_bees_synth}{\patternimg{0.1}{twin_bees_cropped}} \\ twin bees\index{twin bees}} & \specialcell{\patternlink{twin_bees_synth}{\patternimg{0.1}{twin_bees_synth}}} \\
			
			\rowcolor{gray!20} 
			\specialcell{\embedlink{switch_engine_synth}{\patternimg{0.1}{switch_engine_cropped}} \\ switch engine\index{switch engine}} & \specialcell{\patternlink{switch_engine_synth}{\patternimg{0.1}{switch_engine_synth}}} & & 			\specialcell{\embedlink{eater_2_6_gliders}{\patternimg{0.1}{eater_2_cropped}} \\ eater~2\index{eater 2}} & \specialcell{\patternlink{eater_2_6_gliders}{\patternimg{0.1}{eater_2_6_gliders}}} \\
			
			\specialcell{\embedlink{hwss_4_glider_synth}{\patternimg{0.1}{hwss_cropped}} \\ HWSS\index{heavyweight spaceship}} & \multicolumn{4}{l}{\raisebox{-3.5em}{\patternlink{hwss_4_glider_synth}{\patternimg{0.1}{hwss_4_glider_synth}}}} \\\bottomrule
		\end{tabular}
...
% ONE MORE SWITCH ENGINE SYNTH IN RLE FILE NOT DISPLAYED HERE DUE TO NO ROOM
...
\begin{figure}[!ht]
	\centering\embedlink{fumarole_sequential}{\vcenteredhbox{\patternimg{0.088}{fumarole_sequential_2}} \vcenteredhbox{\gliderarrow{3}} \vcenteredhbox{\patternimg{0.088}{fumarole_sequential_3}} \vcenteredhbox{\gliderarrow{2}} \vcenteredhbox{\patternimg{0.088}{fumarole_sequential_4}} \vcenteredhbox{\gliderarrow{2}} \vcenteredhbox{\patternimg{0.088}{fumarole_sequential_5}} \vcenteredhbox{\gliderarrow{3}} \vcenteredhbox{\patternimg{0.088}{fumarole_sequential_6}}}
	\caption{A $12$-glider incremental synthesis of a fumarole ($2$ gliders that are not shown are required to synthesize the initial beehive). The cells that were created or modified in the previous step of the synthesis are shown in \bgbox{redback}{red}, and the gliders that will be involved in the next collision are shown in \bgbox{greenback}{green}.}\label{fig:fumarole_sequential}
\end{figure}
...
\begin{table}[!htp]\vspace*{0.05in}
	\begin{center}		
		\begin{tabular}{Sc Sl}
			...
			\specialcell{\embedlink{ship_sequential}{\patternimg{0.1}{ship_cropped}} \\ ship\index{ship}} & \specialcell{\patternlink{ship_sequential}{\patternimg{0.1}{ship_sequential}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{tub_sequential}{\patternimg{0.1}{tub_cropped}} \\ tub\index{tub}} & \specialcell{\patternlink{tub_sequential}{\patternimg{0.1}{tub_sequential}}} \\
			
			\specialcell{\embedlink{tub_with_tail_sequential}{\patternimg{0.1}{tub_with_tail_cropped}} \\ tub with tail\index{tub with tail}} & \specialcell{\patternlink{tub_with_tail_sequential}{\patternimg{0.1}{tub_with_tail_sequential}}} \\
			
			\rowcolor{gray!20}
			\specialcell{\embedlink{hat_sequential}{\patternimg{0.1}{hat_cropped}} \\ hat\index{hat}} & \specialcell{\patternlink{hat_sequential}{\patternimg{0.1}{hat_sequential}}} \\
			...
			\rowcolor{gray!20}
			\specialcell{\embedlink{t_tetromino_incremental}{\patternimg{0.1}{tl_cropped}} \\ T-tetromino / traffic~light\index{T-tetromino}\index{traffic light}} & \specialcell{\patternlink{t_tetromino_incremental}{\patternimg{0.1}{t_tetromino_incremental}}} \\
			
			\specialcell{\embedlink{honey_farm_incremental}{\patternimg{0.1}{hf_cropped}} \\ honey~farm\index{honey farm}} & \specialcell{\patternlink{honey_farm_incremental}{\patternimg{0.1}{honey_farm_incremental}}} \\
			
			\rowcolor{gray!20}\specialcell{\embedlink{snake_sequential}{\patternimg{0.1}{snake_cropped}} \\ snake\index{snake}} & \specialcell{\patternlink{snake_sequential}{\patternimg{0.1}{snake_sequential}}} \\
			
			\specialcell{\embedlink{lwss_sequential}{\patternimg{0.1}{lwss_cropped}} \\ LWSS\index{lightweight spaceship}} & \specialcell{\patternlink{lwss_sequential}{\patternimg{0.1}{lwss_sequential}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{mwss_sequential}{\patternimg{0.1}{mwss_cropped}} \\ MWSS\index{middleweight spaceship}} & \specialcell{\patternlink{mwss_sequential}{\patternimg{0.1}{mwss_sequential}}} \\
			
			\specialcell{\embedlink{hwss_sequential}{\patternimg{0.1}{hwss_cropped}} \\ HWSS\index{heavyweight spaceship}} & \specialcell{\patternlink{hwss_sequential}{\patternimg{0.1}{hwss_sequential}}} \\
			
			\rowcolor{gray!20} \specialcell{\embedlink{pentadecathlon_sequential}{\patternimg{0.1}{pentadecathlon_cropped}} \\ pentadecathlon\index{pentadecathlon}} & \specialcell{\patternlink{pentadecathlon_sequential}{\patternimg{0.1}{pentadecathlon_sequential}}} \\\bottomrule
		\end{tabular}
	...
	\end{center}
\end{table}
% MAYBE ADD MORE HONEYFARM INCREMENTAL SYNTHESES OR OTHER UNSTABLE INCREMENTAL SYNTHESES? IF SO, MAYBE REMOVE IMAGE OF HF TO MAKE THAT ROW SHORTER
...
Because incremental synthesis typically works by first constructing a still life or a collection of still lifes, and then transforming those still lifes into the desired object, the Life community has gone to great lengths to synthesize still lifes. In fact, syntheses are known for all 32,538 strict still lifes with $18$ or fewer live cells. Mark Niemiec maintains a large database of glider syntheses that is available at \httpurl{codercontest.com/mniemiec/lifepage.htm}
...
\begin{figure}[!ht]
	\centering
	\embedlink{ecologist_synth}{\vcenteredhbox{\patternimg{0.12}{ecologist_synth0}} \vcenteredhbox{\gliderarrow{3}}
	\vcenteredhbox{\patternimg{0.12}{ecologist_synth1}} \vcenteredhbox{\gliderarrow{3}} \vcenteredhbox{\patternimg{0.12}{ecologist_synth2}} \vcenteredhbox{\gliderarrow{2}} \vcenteredhbox{\patternimg{0.12}{ecologist_synth3}} \vcenteredhbox{\gliderarrow{4}} \vcenteredhbox{\patternimg{0.12}{ecologist_synth4}}}
...
\begin{figure}[!ht]
	\centering
	\embedlink{coe_ship_incremental}{\vcenteredhbox{\patternimg{0.1}{coe_ship_synth_0}} \vcenteredhbox{\gliderarrow{4}}
		\vcenteredhbox{\patternimg{0.1}{coe_ship_synth_1}} \vcenteredhbox{\gliderarrow{2}} \vcenteredhbox{\patternimg{0.1}{coe_ship_synth_2}}}
...
\subsection{Corderships}\label{sec:incremental_schick}\index{Cordership}
...
\begin{figure}[!ht]
	\centering
	\embedlink{3_engine_cordership_synthesis}{\vcenteredhbox{\phantom{$\cdots$ \genarrow{20}}} \vcenteredhbox{\patternimg{0.1}{3_engine_cordership_synthesis_0}} \vcenteredhbox{\fixarrowc{45}} \vcenteredhbox{\patternimg{0.1}{3_engine_cordership_synthesis_45}}} \\[1em]
	
	\patternlink{3_engine_cordership_synthesis}{\vcenteredhbox{$\cdots$ \genarrow{61}} \vcenteredhbox{\patternimg{0.1}{3_engine_cordership_synthesis_106}} \vcenteredhbox{\genarrow{288}} \vcenteredhbox{\patternimg{0.1}{3_engine_cordership_synthesis_394}}} \\[1em]
	
	\caption{A $15$-glider synthesis of the $3$-engine Cordership, which was found by Jason Summers in 2004. The $3$~switch engines are synthesized by the \bgbox{aquaback}{aqua}, \bgbox{magentaback}{magenta}, and \bgbox{greenback}{green} glider collisions. The remaining $3$~gliders clean up some extra debris that is left behind by the switch engines.}\label{fig:3_engine_cordership_synthesis}
\end{figure}
...
\begin{figure}[!ht]
	\centering\embedlink{richs_p16_soup}{\vcenteredhbox{\patternimg{0.1}{richs_p16_soup}} \vcenteredhbox{\genarrow{196}} \vcenteredhbox{\patternimg{0.125}{richs_p16_soup_196}}}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}{.48\textwidth}
		\centering\patternlink{richs_p16_soup}{\patternimg{0.125}{richs_p16_soup_164}}
		\caption{Generation~164.}\label{fig:richs_p16_soup_164}
	\end{subfigure} \ \ \ \ % 
	\begin{subfigure}{.48\textwidth}
		\centering\patternlink{richs_p16_soup}{\patternimg{0.125}{richs_p16_soup_155}}
		\caption{Generation~155.}
		\label{fig:richs_p16_soup_155}
	\end{subfigure}
	\caption{Rich's p16 is created when (a)~two honey farm predecessors (highlighted in \bgbox{yellowback2}{yellow}) and two B-heptominoes (highlighted in \bgbox{greenback}{green}) collide with two blocks and two beehives (highlighted in \bgbox{magentaback}{magenta}). The honey farm predecessors can be identified by comparing them with Figure~\ref{fig:pre_honeyfarm}, and the B-heptomino can be identified by going backward to generation~155 of the soup as in~(b).}\label{fig:richs_p16_soup_detailed}
\end{figure}
...
\begin{figure}[!ht]
	\centering\embedlink{richs_p16_predecessor}{\vcenteredhbox{\patternimg{0.1}{richs_p16_predecessor}} \vcenteredhbox{\genarrow{32}} \vcenteredhbox{\patternimg{0.1}{richs_p16_predecessor_32}}}
...
\begin{figure}[!ht]
	\centering\includegraphics[width=0.7\textwidth]{glider_synthesis/breeder_front.png}
...
\begin{figure}[!ht]
	\centering\patternimglinkwidth{0.95\textwidth}{breeder_done}
	\caption{A breeder constructed using an incremental glider synthesis of a Gosper glider gun. First, a forward and backward period~60 space rake are used to collide two gliders and create a pond as in Figure~\ref{fig:breeder_front} (outlined on the right in \bgbox{yellowback2}{yellow}), followed by another forward and backward space rake colliding two gliders to create a block (outlined in \bgbox{greenback}{green}). Next, a backward space rake uses one glider to convert the pond into a ship (outlined in \bgbox{aquaback}{aqua}), and finally another backward space rake uses one glider to convert the ship into a queen bee (outlined in \bgbox{magentaback}{magenta}), thus completing the synthesis of the Gosper glider gun.}\label{fig:breeder_done}
\end{figure}
...
\begin{figure}[!ht]
	\centering\includegraphics[width=0.95\textwidth]{glider_synthesis/breeder_done_1200.png}
...
In Section~\ref{sec:incremental_synthesis}, we saw that we can often break glider syntheses down into bits and pieces that are individually easy to understand and make use of. In this section, we take this idea to its most extreme by considering \emph{slow salvos}\index{salvo}, which are collections of gliders\footnote{Technically, a salvo can be made up of any spaceships, but the term almost always refers to gliders.} that (1) are \emph{slow}: only one glider interacts in the synthesis at a time, and (2) form a \emph{salvo}: all of the gliders come from the same direction.
...
\begin{figure}[!ht]
	\centering\embedlink{slow_salvo_splitter}{\vcenteredhbox{\patternimg{0.1}{slow_salvo_splitter_0}} \vcenteredhbox{\gliderarrow{1}} \vcenteredhbox{\patternimg{0.1}{slow_salvo_splitter_1}} \vcenteredhbox{\gliderarrow{1}} \vcenteredhbox{\patternimg{0.1}{slow_salvo_splitter_2}}}
...
\begin{figure}[!ht]
	\centering\raisebox{-0.5\height}{\begin{tikzpicture}[scale=0.5, every node/.style={transform shape}]%
	\node[inner sep=0pt,anchor=south west] at (0,0) {\embedlink{create_one_time_turner}{\patternimg{0.195}{create_one_time_turner_0}}};
				
	\colorletternode{green}{4.2}{3.75}{1}
	\colorletternode{green}{4.15}{5.9}{2}
	\end{tikzpicture}} \patternlink{create_one_time_turner}{\vcenteredhbox{\gliderarrow{2}}} \raisebox{-0.5\height}{\begin{tikzpicture}[scale=0.5, every node/.style={transform shape}]%
	\node[inner sep=0pt,anchor=south west] at (0,0) {\patternlink{create_one_time_turner}{\patternimg{0.195}{create_one_time_turner_2}}};
	...
	\end{tikzpicture}} \patternlink{create_one_time_turner}{\vcenteredhbox{\gliderarrow{8}}} \raisebox{-0.5\height}{\begin{tikzpicture}[scale=0.5, every node/.style={transform shape}]%
	\node[inner sep=0pt,anchor=south west] at (0,0) {\patternlink{create_one_time_turner}{\patternimg{0.195}{create_one_time_turner_10}}};
	
	\colorletternode{green}{5.05}{4.8}{1}
	\colorletternode{green}{5}{7}{2}
	\end{tikzpicture}} \patternlink{create_one_time_turner}{\vcenteredhbox{\gliderarrow{2}}} \raisebox{-0.5\height}{\begin{tikzpicture}[scale=0.5, every node/.style={transform shape}]%
	\node[inner sep=0pt,anchor=south west] at (0,0) {\patternlink{create_one_time_turner}{\patternimg{0.195}{create_one_time_turner_12}}};
	\end{tikzpicture}}
	\caption{A p1 slow salvo of 12 gliders can be used to create the one-time turner from Figure~\ref{fig:one_time_turner} and leave us with another block left over (to create additional turners or other objects with). The first two gliders duplicate the initial block, using the reaction from Figure~\ref{fig:slow_salvo_splitter}. The next $8$ gliders move one of the blocks down and to the right, and then the final two gliders duplicate that moved block. The order in which the gliders should come in is indicated by the \bgbox{greenback}{green} numbers---their exact timing does not matter, as long as they are far enough apart that each collision settles down before the next glider arrives.}
	\label{fig:create_one_time_turner}
\end{figure}

Thus we can use a total of $13$ gliders in a p1 slow salvo ($12$ to create the one-time turner and $1$ to use and destroy it) to create one glider in a perpendicular direction, while still having a block left over to perform additional constructions with. Using this technique, we are now able to emulate multi-directional glider syntheses from unidirectional ones. For example, consider the four-glider syntheses of the clock\index{clock} that we saw in Table~\ref{tab:other_glider_synth}, which use one glider coming from each of the four possible directions. A unidirectional synthesis of the clock can be constructed by using a p1 slow salvo to construct four one-time turners (one of the gliders does not need to be turned at all, two gliders need to be turned once each, and one glider needs to be turned twice) and then firing four gliders at the one-time turners with the proper timing. An explicit configuration of one-time turners that works is displayed in Figure~\ref{fig:unidirection_clock_synthesis}.\footnote{We do not explicitly demonstrate how to create this arrangement of blocks using a p1 slow salvo, since it would require dozens of gliders.}

\begin{figure}[!ht]
	\centering\embedlink{unidirection_clock_synthesis}{\vcenteredhbox{\patternimg{0.097}{unidirection_clock_synthesis}} \vcenteredhbox{\genarrow{135}} \vcenteredhbox{\patternimg{0.097}{unidirection_clock_synthesis_135}}}
...
\begin{figure}[!ht]
	\centering
	\embedlink{clock_inserter_effective}{\vcenteredhbox{\patternimg{0.1}{clock_inserter_effective_0}} \vcenteredhbox{\genarrow{52}} \vcenteredhbox{\patternimg{0.1}{clock_inserter_effective_52}}}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}{.17\textwidth}
		\centering\patternimglink{0.1}{14_cell_synth}
		\caption{$14$ cells.}\label{fig:14_cell_synth}
	\end{subfigure} \ \ \ \ % 
	\begin{subfigure}{.17\textwidth}
		\centering\patternimglink{0.1}{15_cell_synth}
		\caption{$15$ cells.}\label{fig:15_cell_synth}
	\end{subfigure} \ \ \ \ % 
	\begin{subfigure}{.17\textwidth}
		\centering\patternimglink{0.1}{16_cell_synth}
		\caption{$16$ cells.}\label{fig:16_cell_synth}
	\end{subfigure} \ \ \ \ % 
	\begin{subfigure}{.17\textwidth}
		\centering\patternimglink{0.1}{17_cell_synth}
		\caption{$17$ cells.}\label{fig:17_cell_synth}
	\end{subfigure} \ \ \ \ % 
	\begin{subfigure}{.17\textwidth}
		\centering\patternimglink{0.1}{18_cell_synth}
...
\begin{figure}[!htb]
	...
	\caption{A summary of a massive $94$-glider incremental synthesis of a hard-to-construct 17-cell still life (shown at the bottom right). Each stage in the synthesis works by using another glider collision to transform one still life into another. The cells that were created or modified in the previous step of the synthesis are shown in \bgbox{redback}{red}, and the gliders that will be involved in the next collision are shown in \bgbox{greenback}{green}.}\label{fig:17_cell_synthesis}
\end{figure}

Rather than trying to push these techniques to synthesize all still lifes with 19 live cells, focus has shifted somewhat to trying to reduce the number of gliders required to synthesize these objects. It has been known for decades how to synthesize all still lifes with $8$ or fewer cells via $4$ or fewer gliders. Similarly, glider syntheses are known for constructing every still life with $9, 10, 11, 12,$ and $13$ live cells via $5, 9, 9, 11,$ and $12$ or fewer gliders, respectively.\footnote{It was not known how to synthesize the $9$-cell long$^3$ snake\index{long$^3$ snake} with fewer than $6$ gliders until February 2015, when Matthias Merzenich derived a $5$-glider synthesis from an apgsearch\index{apgsearch} soup.} Recent efforts have attempted to continue this pattern and synthesize all small still lifes in fewer than $1$ glider per live cell. This project was completed for $14$-, $15$-, $16$-, and $17$-cell still lifes in October 2016, November 2016, May 2017, and September 2019, respectively. For example, we now know how to construct the $17$-cell still life from Figure~\ref{fig:17_cell_synthesis} (which was first synthesized by $94$ gliders) via just $10$ gliders---see Figure~\ref{fig:17_cell_synthesis_small}.
...
% Term "kickback" for using two/three gliders to create a single glider in another direction
...
\end{problem}
% pi, honeyfarm, move block, final 3 annihilate both glider and block
...
\begin{problem}\label{exer:hwss_gun}
	...
	\begin{enumerate}[label=(\alph*)]
		...
		\item One way to overcome this problem is to use \emph{glider pushers}\index{glider!pusher} (see Figure~\ref{fig:glider_pusher}) to repeatedly push one glider stream closer to another. How many glider pushers would you need to use to fix the problem from part~(a)?\medskip
		
		\noindent\begin{minipage}{\linewidth}
			\centering
			\patternimglink{0.1}{glider_pusher}
			\captionof{figure}{\footnotesize A \emph{glider pusher} is a configuration of a queen bee (top center) and a pentadecathlon (middle right) that was found by Dietrich Leithner in December 1993. It pushes a passing glider away by one lane, and thus closes gaps between glider streams with periods that are a multiple of $30$.}\label{fig:glider_pusher}\medskip
		\end{minipage}
	\end{enumerate}
\end{problem}
...
% Solution: http://conwaylife.com/forums/viewtopic.php?t=&p=54444#p54453
...
\begin{problem}\label{exer:glider_synth_tee}
	By using the $3$-glider collision in Table~\ref{tab:3_glider_synth} called a ``tee'',\index{tee} which produces a glider perpendicular to each of the input gliders, we can modify many glider syntheses so that all input gliders come from two directions that are opposite each other. Use this technique to create glider syntheses of each of the following patterns, with the property that all gliders come from two opposing directions.
	\begin{enumerate}[label=(\alph*)]
		\item A switch engine.
		
		\item A clock.
		
		\item Twin bees.\index{twin bees}
	\end{enumerate}
\end{problem}
...
\begin{problem}\label{exer:clock_inserter_use}
	...
	\vspace*{-0.3cm}\begin{multicols}{2}
		\begin{enumerate}[label=(\alph*)]
			\item \raisebox{-\height+0.5em}{\patternimglink{0.1}{clock_inserter_use_b}}
			
			\item \raisebox{-\height+0.5em}{\patternimglink{0.1}{clock_inserter_use_c}}
			
			\item \raisebox{-\height+0.5em}{\patternimglink{0.1}{clock_inserter_use_d}}
		\end{enumerate}
	\end{multicols}
\end{problem}
...
\begin{problem}\label{exer:other_inserters}
	...
	\begin{enumerate}[label=(\alph*)]
		...
		\item Use an eater~1\index{eater 1} to insert a glider $15$~generations in front of another glider. [Hint: Refer to Exercise~\ref{exer:boat_one_time_turner}(b).]
...
\begin{problem}\label{exer:other_blockic}
	Create blockic seeds\index{blockic seed} for each of the following objects. [Hint: These can all be created using the same techniques that we used to make the blockic seed in Figure~\ref{fig:clock_slow_salvo}.]
	\begin{enumerate}[label=(\alph*)]
...
% TODO: This exercise is referenced in chapter 8. We should include its solution?
\begin{problem}\label{exer:2_engine_corder_seed}
	A \emph{seed}\index{seed} is a constellation (i.e., a collection of simple still lifes and maybe small p$2$ oscillators) that, when hit by one or more gliders, evolves into a more complicated object. Synthesizing a seed via standard glider collisions and then using that seed to synthesize a more complicated object is a particularly useful technique when working with slow salvo synthesis.
	\begin{enumerate}[label=(\alph*)]
