...
% TODO(?): <1 glider per bit for 18-cell? or just RCT?
...
\begin{problem}\label{exer:ecologist_synth}
	Complete the incremental glider synthesis of the ecologist presented in Figure~\ref{fig:ecologist_synth_b} (i.e., construct it in its entirety from an arrangement of gliders). This synthesis should only use gliders coming from the bottom-left and bottom-right.
