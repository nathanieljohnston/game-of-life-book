...
% Need to mention that B2D requires a slower clock (2^24?), when using Osqrtlogt. this is also why it needs such a big space between logic unit and thing it prints
