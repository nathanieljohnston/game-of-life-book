...
% This is the last todo thing in the book!
\begin{figure}[!htbp]
...
\vspace*{-0.4cm}\hrulefill\vspace*{-0.3cm}\footnotesize\begin{multicols}{2}\vspace*{-0.4cm}\raggedcolumns\interlinepenalty=10000
	...
	% TODO: Add hint/note here that you can move it much closer in Koch snowflake, but not in Osqrtlogt (since former has no READs). Maybe reword to "why is it so much farther away in Fig?? than in Fig??". Probably should be 3-difficulty, not 2
	...
	\begin{problem}\label{exer:osqrt_logt_sbr_order} \probdiff{2}
		The extremely slowly-growing pattern from Figure~\ref{fig:osqrtlogt} makes use of three sliding block registers (highlighted in green): \texttt{U0}, \texttt{U1}, and \texttt{U2}, as described by APGsembly~\ref{alg:apgsembly_slow_growth}. Identify which register is which.
	\end{problem}
