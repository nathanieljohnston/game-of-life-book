...
% TODO: Color the output lanes green to better highlight them maybe?
\begin{figure}[!htb]
	\centering
...
% Main TODO here is to color various pieces of the figure according to which track they create.
\begin{figure}[!htb]
	\centering
	\gridbox{0.5pt}{\patternimglink{0.363}{31c_240_track_builder}}
	\caption{Track builder. Still lots to do here.}\label{fig:31c_240_track_builder}
\end{figure}

However, we still do not have a method of constructing the two other block tracks, since there is no way to arrange kickback reactions so as to...
