...
\begin{figure}[!htb]
	...
	\begin{subfigure}[b]{0.43\textwidth}
		\centering
		\embedlink{g_2h_to_m}{\vcenteredhbox{\patternimg{0.13}{g_2h_to_m}} \vcenteredhbox{\genarrow{38}} \vcenteredhbox{\patternimg{0.13}{g_2h_to_m_38}}}
...
% TWo figures, side by side again
...
% TODO: Exercise from calcyman's backward rake idea
% EXERCISE: R3L28. Why doesn't make it any shorter? Rebuild anyway
...
\end{problem}
% They are a rephaser (really they are there since we will turn them into a forward rake in the completed silverfish, but for this exercise it's fine to just say that they adjust the lanes of the gliders so that the proper kickback/synthesis reactions happen).
...
\begin{problem}\label{exer:self_support_spaceships_r2l16}
	...
	\end{enumerate}
\end{problem}
% Side note: This rake is the one from Exercise~\ref{exer:self_support_spaceships_r4l1}, but with the double kickbacks removed.
