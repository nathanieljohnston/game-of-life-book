...
For such a reaction to actually be usable at the core of a self-supporting spaceship, it also needs to produce some sort of output (ideally a glider) that can then be used to synthesize the spaceships that pull the stable object. One such reaction, which uses three xWSS flotillae to move a loaf forward while also generating a glider, is displayed in Figure~\ref{fig:caterloopillar_loaf_mover}.


\begin{figure}[!htb]
	\centering
	\embedlink{caterloopillar_loaf_mover}{\vcenteredhbox{\phantom{$\cdots$ \genarrow{224}}} \vcenteredhbox{\includegraphics[width=0.883\textwidth]{self_support_spaceships/caterloopillar_loaf_mover_0.pdf}}} \\[1em]
	
	\patternlink{caterloopillar_loaf_mover}{\vcenteredhbox{$\cdots$ \genarrow{224}} \vcenteredhbox{\includegraphics[width=0.883\textwidth]{self_support_spaceships/caterloopillar_loaf_mover_224.pdf}}} \\[1em]
	
	\patternlink{caterloopillar_loaf_mover}{\vcenteredhbox{$\cdots$ \genarrow{164}} \vcenteredhbox{\includegraphics[width=0.883\textwidth]{self_support_spaceships/caterloopillar_loaf_mover_388.pdf}}} \\[1em]
	
	\patternlink{caterloopillar_loaf_mover}{\vcenteredhbox{${} \ \cdots$ \genarrow{64}} \vcenteredhbox{\includegraphics[width=0.883\textwidth]{self_support_spaceships/caterloopillar_loaf_mover_452.pdf}}}
	
	\caption{An arrangment of three xWSS flotillae that move a loaf forward by $46$~cells and simultaneously create a glider. The first $4$-xWSS flotilla (highlighted in \bgbox{magentaback}{magenta}) turns the loaf into a glider, the next $3$-MWSS flotilla (highlighted in \bgbox{aquaback}{aqua}) reflects that glider, and finally the $2$-xWSS flotilla (highlighted in \bgbox{greenpastel}{green}) creates a loaf from that glider (without destroying it). Moving the aqua flotilla northwest by $n$~cells and the green flotilla west by $2n$~cells results in the loaf being moved forward by $46 + 2n$~cells.}\label{fig:caterloopillar_loaf_mover}
\end{figure}

% Talk about adjustability here
