...
\begin{figure}[!htb]
	...
	\begin{tabular}{@{}ccc@{}}
		\begin{subfigure}{.46\textwidth}
			...
			\caption{If an input glider is \emph{not} present then an output glider will appear at the location marked in \bgbox{orangeback}{orange} $30$ generations after the phase shown here (i.e., the output stream is $5$ cells further south than the input stream).}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}{.48\textwidth}
		\centering
		\patternlink{stream_inverter}{\vcenteredhbox{\patternimg{0.12}{inverter1_0}} \vcenteredhbox{\genarrow{12}} \vcenteredhbox{\patternimg{0.12}{inverter1_12}}}
...
\subsection{An LWSS Gun with an Irregular Stream}\label{sec:primer_irregular_stream}
...
\begin{figure}[!htb]
	...
	\begin{tabular}{@{}ccc@{}}
		...
		\begin{subfigure}{.345\textwidth}
			\centering
			\patternlink{twin_bees_reflect}{\patternimg{0.09}{twin_bees_reflect_b}}
			\caption{two more reflections}
			\label{fig:twin_bees_reflect_b}
		\end{subfigure} &
		\begin{subfigure}{.325\textwidth}
			\centering
			\patternlink{twin_bees_reflect}{\patternimg{0.09}{twin_bees_reflect_c}}
...
\begin{figure}[!htb]
	...
	\begin{tabular}{@{}ccc@{}}
		...
		\begin{subfigure}{.3\textwidth}
			...
			\caption{LWSS-to-MWSS converter}
...
\begin{figure}[!htb]
	...
	\begin{tabular}{@{}cc@{}}
		\begin{minipage}[t]{0.208\textwidth}
			\centering
			\patternimglink{0.15830666666}{twin_bees_duplicate_reflector}
